  ...
  return (
    <div>
      ...
      <div className="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <h1 className="display-4">The First Words</h1>
...
{/* 
      <div className="card flex-md-row mb-4 box-shadow h-md-250 p-0">
        <img className="card-img-top w-100" src={firstWBanner} alt="Thumbnail" />
      </div>
*/}
...
<p>This is (personally) one of the most difficult parts of writing – actually committing the first words to the page. Starting subsequent chapters and different scenes can be difficult for the same reason. It shouldn’t be. When you start, you have the most latitude to experiment, to make mistakes and change things that don’t work, compared to finishing up, when everything needs to start making sense.</p>

              <h2 id="post-17-2" className="blog-post-title">17.2: The 4 'W's</h2>
...
<ol>
  ...
  <li>Why: least priority; doesn’t really need to be apparent why anything is happening just yet, as long as what is happening is interesting. If what is happening is not interesting, then you may need to state, early on, why the reader should care. </li>
              ...
              <h2 id="post-17-3" className="blog-post-title">17.3: Wide or Narrow</h2>
...
<p className='indent-text-1'>No one would have believed in the last years of the nineteenth century that this world was being watched keenly and closely by intelligences greater than man's...</p>
<p>(War of the Worlds, H. G. Wells)</p>

<p><strong>Narrow:</strong></p>
<p className='indent-text-1'>Mother died today. Or maybe yesterday; I can't be sure. </p>
<p>(The Stranger, Albert Camus)</p>

<p><strong>Wide:</strong></p>
<p className='indent-text-1'>It was now lunch time and they were all sitting under the double green fly of the dining tent pretending that nothing had happened</p>
<p>(The Short Happy Life of Francis Macomber, Ernest Hemingway)</p>
...
<p>Hart explains:<a href="#f1"><sup>1</sup></a> You also can create a sense of narrative motion by describing the approach to a scene, moving from the long view to the scene itself, as Tracy Kidder did when he first described Paul Farmer’s Haitian medical clinic:</p>
<u>Storycraft: Complete Guide to Writing Narrative Nonfiction, Jack Hart.</u>
<p className='indent-text-1'>In daylight, in an all but treeless, baked brown landscape, Sanmi Lasante makes a dramatic appearance, like a fortress on its mountainside, a large complex of concrete buildings, half covered with tropical greenery. Inside the walls, the world turns leafy. Tall trees stand beside courtyards and walkways and walls, artful constructions of concrete and stone, which mount the forested hillside.</p>
<p>The initial view is from a distance. The clinic sits isolated in the brown landscape. But then Kidder zooms into the leafy green world of the clinic itself, duplicating the experience you would have if you visited Sanmi Lasante yourself.</p>

<h2 id="post-17-4" className="blog-post-title">17.4: Close or Distant</h2>
...
<p>By contrast, if your character is an everyman or everyday person, your writing stands to gain more credibility or self-importance by distancing the character, focusing on facts and action over interiority (and the dreaded 'ego Viagra' of introspective writing). Your reader is likely also an 'every person' and don't want/need access into another every-person's mind. They want to see an ordinary person have extraordinary things happen to them, making journalistic, distancing writing more effective.</p>

              <h2 id="post-17-5" className="blog-post-title">17.5: A Big Scene and a Small Scene</h2>
<p>R. Meredith and J. Fitzgerald say that the first chapter should have a ‘big scene’ for conflict, and a ‘small scene’ for characterisation and providing preliminary information (to answer the initial ‘who, what, where, why’). </p>

              <h2 id="post-17-6" className="blog-post-title">17.6: Order of Information</h2>
<h5>17.5.1 	Characters</h5>
...
<p>To illustrate, compare the films ‘The Lion King’ and ‘Beauty and the Beast.’ </p>
 ...
 <p className='purple-bold'>The Lion King:</p>
<p>The film starts and ends in the same setting; Pride Rock. However, the protagonist (Simba) has changed completely since then, i.e. by contrast, by the end, the last time we saw the protagonist in the setting, he was a very different character. Putting the character in the same setting emphasises the difference, because it proves it was not a setting change which changed the character (i.e. he doesn’t change back when he returns to the same setting), it was a natural personality shift.</p>
 ...
 <p className='purple-bold'>Beauty and the Beast</p>
...
<p>Both examples convey that the personalities of the protagonists are authentic as they are not based on setting, or the company the protagonist keeps. </p>
              ...
              <h2 id="post-17-7" className="blog-post-title">17.7: First Line</h2>
...
<p>William Sloane explains: <i>“Those first sentences of a novel are a contract between the writer of fiction and the reader who commences to read him. The contract has to be clear almost at once.”</i><a href="#f2"><sup>2</sup></a></p>
<p>He recounts an article that said:</p>

<p className='indent-text-1'>“Granted, you can't tell a book by its cover. But you can tell a book worth reading by its title and the first sentences. Gushing onto the market this winter and spring—like an artesian well of printed words—are a mob of new literate voices babbling to be heard behind the brilliantly illustrated covers of hundreds of books.</p>
<p className='indent-text-1'>For the most part, these new novels . . . are destined for bargain table piles unsold at 50 cents a copy. Even at that reduced price they are no bargain. The authors, while quite able to put one English word after another, have, in total, nothing to say, and the people they write about are as worthless  and uninteresting as gum wrappers in the gutter.”</p>

<p>He goes on:</p>
<p className='indent-text-1'>"The author of this blast goes on to cite a number of novels and their opening sentences, comparing them with the first sentences of books by the masters of fiction, Faulkner, Hemingway, and Algren, to name three. Not one of the openings cited as atrocious was by a writer who has subsequently achieved his or her own readership."</p>

<h5>17.6.2 	Features of a Strong First Line</h5>
...
<p className='indent-text-1'>Last night I dreamt of Manderley again...<a href="#f3"><sup>3</sup></a></p>
<p className='indent-text-1'>"Don't look now," John said to his wife, "but there are a couple of old girls two tables away who are trying to hypnotise me." <a href="#f4"><sup>4</sup></a></p>
<p className='indent-text-1'>They told me afterwards they had found nothing.<a href="#f5"><sup>5</sup></a></p>
<p className='indent-text-1'>On December the third the wind changed overnight and it was winter.<a href="#f6"><sup>6</sup></a></p>
<p className='indent-text-1'>He had been asleep for about ten minutes.<a href="#f7"><sup>7</sup></a></p>
<p className='indent-text-1'>It was three months after she died that he first noticed the apple tree.<a href="#f8"><sup>8</sup></a></p>
...
<p className='indent-text-1'>What is it Pilot John says right before we drop from the sky? Where is Molly’s body? <a href="#f9"><sup>9</sup></a></p>
<p className='indent-text-1'>I write this: The cops don’t know what really happened in Eagle Talon. Lies, all lies. Ask Jessica, if I ever see her again. <a href="#f10"><sup>10</sup></a></p>
<p className='indent-text-1'>The Bentley nosed into the weeds along the shoulder of the road and died.<a href="#f11"><sup>11</sup></a></p>
<p className='indent-text-1'>I see Miranda in the endless chain of faces.<a href="#f12"><sup>12</sup></a></p>
<p className='indent-text-1'>Like the Shroud of Turin, the disfigured shape in the photograph was a face waiting to be born.<a href="#f13"><sup>13</sup></a></p>
<p className='indent-text-1'>...Over the course of the long afternoon of thunderclaps and rain squalls they had unpacked most of the living room of the ancestral home.<a href="#f14"><sup>14</sup></a></p>
<p className='indent-text-1'>October 2004 Virgil acquired the cute little blue-and-white-pinstriped Cessna at an auction; this over Danni’s strenuous objections.<a href="#f15"><sup>15</sup></a></p>
<p className='indent-text-1'>We bought supplies for our road trip at an obscure general goods store in Seattle—a multi-generational emporium where you could purchase anything from space-age tents to snowshoes once worn by Antarctic explorers. That’s where we came across the guidebook.<a href="#f16"><sup>16</sup></a></p>
<p className='indent-text-1'>Kenshi Suzuki and Swayne Harris had a chance reunion at a bathhouse in an Indian tourist town.<a href="#f17"><sup>17</sup></a></p>
...
<p className='indent-text-1'>The Welcome Wagon lady, sixty if she was a day but working at youth and vivacity (ginger hair, red lips, a sunshine-yellow dress), twinkled her eyes and teeth 	at Joanna and said, ‘You’re really going to like it here! It’s a nice town with nice people! You couldn’t have made a better choice!’<a href="#f18"><sup>18</sup></a></p>

<p>The central question here is, 'who acts like this at 60?' Resolving this contradiction wraps up the entire plot.</p>

<h5>17.6.3 	Examples</h5>
...
<p className='purple-bold'>Bad Example #1</p>
<p className='indent-text-1'>The girl’s head rested on a small pile of orange-and-brown leaves.</p>
...
<p className='indent-text-1'>A pile of dead leaves rested on the girl’s head.<a href="#f19"><sup>19</sup></a></p>
...
<p className='purple-bold'>Bad Example #2</p>
<p className='indent-text-1'>The little girl's hair is fine as cornsilk.<a href="#f20"><sup>20</sup></a></p>
...
<p className='purple-bold'>Bad Example #3</p>
<p className='indent-text-1'>We are a tearless, tiny crowd, we survivors of David Shaw.<a href="#f21"><sup>21</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>The survivors of David Shaw were a tiny crowd, and no one cried.</p>

<p className='purple-bold'>Bad Example #4</p>
<p className='indent-text-1'>Scott Carey knocked on the door of the Ellis condo unit, and Bob Ellis (everyone in Highland Acres still called him Doctor Bob, although he was five years retired) let him in.<a href="#f22"><sup>22</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Doctor Bob stood in the doorway of his condo unit, and for a long time, stared at Scott Carey.</p>

<p className='purple-bold'>Bad Example #5</p>
<p className='indent-text-1'>First of all, it was October, a rare month for boys.<a href="#f23"><sup>23</sup></a></p>
<p>Never start a first line ‘first of all,’ it’s redundant. </p>
<p>The concept is that October is too infrequent for boys and/or it’s over too fast. Why not girls, too? These are not questions generated by interest, but by misunderstanding; i.e. the wrong kind of questions. No one cares if what is said here is true. There is nothing you can do to fix this line, but, frustratingly, a couple of paragraphs later, you have this line: <i>‘But one strange wild dark long year, Halloween came early.’</i> Get rid of the adjectives until you have ‘One strange year, Halloween came early,’ and you have an award-winning first line. So close, Ray!</p>

<p className='purple-bold'>Bad Example #6</p>
<p className='indent-text-1'>Sarah Shepherd watched her husband come down the stairs.<a href="#f24"><sup>24</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Sarah watched her husband come down the stairs and burst into laughter.</p>

<p className='purple-bold'>Bad Example #7</p>
<p className='indent-text-1'>Hargreaves did not speak until he had turned on two lamps.<a href="#f25"><sup>25</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Only once Hargreaves had lit his lamp, and all eyes were on him, did he speak. </p>

<p className='purple-bold'>Bad Example #8</p>
<p className='indent-text-1'>The hands of the alarm clock on the table in front of Mr. Crangle stood at 3:47, on a summer afternoon.<a href="#f26"><sup>26</sup></a></p>
...
<p className='purple-bold'>Bad Example #9</p>
<p className='indent-text-1'>The red-orange sun eased its way out of the Jamaican sky, then suspended itself halfway into the Caribbean horizon as though holding still for some divine time exposure.<a href="#f27"><sup>27</sup></a></p>
<p>Remember that rule ‘Never Describe Sunsets’? Well it applies literally here. ‘Jamaican’ tries to sex it up but the sunsets in Jamaica aren’t any different from anywhere else.</p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>The red sun dropped below the sky and then it was night in Jamaica.</p>

<p className='purple-bold'>Mediocre Example #1</p>
<p className='indent-text-1'>I bounded over the gray, dusty terrain toward the huge dome of Conrad Bubble.<a href="#f28"><sup>28</sup></a></p>
...
<p className='purple-bold'>Mediocre Example #2</p>
<p className='indent-text-1'>Later, Tom Russell would wonder if the very boards of that place—splintered, unpainted, unlovely—had leaked some sort of lethal courage into his blood and made him see things that could not be true.<a href="#f29"><sup>29</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Later, Tom Russell would wonder if the splintered, unpainted boards of that place made him see things that could not be true.</p>

<p className='purple-bold'>Mediocre Example #3</p>
<p className='indent-text-1'>He was an easy mark.<a href="#f30"><sup>30</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>He would be an easy mark.</p>

<p className='purple-bold'>Mediocre Example #4</p>
<p className='indent-text-1'>The wind whistled through the valley, and the pyramidal tent that signified Outpost 1 quivered before the blast.<a href="#f31"><sup>31</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>The wind whistled through the valley and the tent called Outpost 7 quivered before the blast.</p>

<p className='purple-bold'>Mediocre Example #5</p>
<p className='indent-text-1'>When Janine stopped talking, sometimes as now she seemed to stop breathing also, as if to listen.<a href="#f32"><sup>32</sup></a></p>
...
<p>Fixed Example:</p>
<p className='indent-text-1'>Now Janine stopped talking, in fact, she stopped breathing.</p>

<p className='purple-bold'>Mediocre Example #6</p>
<p className='indent-text-1'>For the tenth time that day, in a voice that shook a little, Martha Halsey read aloud the item in the Dellville Weekly Call.<a href="#f33"><sup>33</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Voice shaking, Martha Halsey read aloud the item in the Dellville Weekly Call.</p>

<p className='purple-bold'>Mediocre Example #7</p>
<p className='indent-text-1'>Henry Tolman got away with murder—he loved that phrase and often turned it over in his mind, gloating.<a href="#f34"><sup>34</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Henry Tolman got away with murder.</p>

<p className='purple-bold'>Mediocre Example #8</p>
<p className='indent-text-1'>I was waiting on the courthouse steps when Norma Krueger, my stepmother, and Russ Tyson, her lover, came out of the building into the harsh November sunlight of Los Angeles.<a href="#f35"><sup>35</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>I was waiting on the courthouse steps when my stepmother came out.</p>

<p className='purple-bold'>Mediocre Example #9</p>
<p className='indent-text-1'>Fran came out of Lila's apartment, shoving the green-printed racing sheets into her apron pocket.<a href="#f36"><sup>36</sup></a></p>
...
<p>Fixed example:</p>
<p className='indent-text-1'>Fran came out of Lila’s apartment shoving the tiny box into her apron pocket.</p>

<p className='purple-bold'>Good Example #1</p>
<p className='indent-text-1'>On the third morning I noticed that somebody had disabled the truck.<a href="#f37"><sup>37</sup></a></p>
...
<p className='purple-bold'>Good Example #2</p>
<p className='indent-text-1'>'Let's face it, Doctor, if an inmate's suicidal there ain't a hell of a lot you can do.’<a href="#f38"><sup>38</sup></a></p>
...
<p className='purple-bold'>Good Example #3</p>
<p className='indent-text-1'>On December the third the wind changed overnight and it was winter.<a href="#f39"><sup>39</sup></a></p>
...
<p className='purple-bold'>Good Example #4</p>
<p className='indent-text-1'>Rafferty was not the only one losing at the blackjack table, but he had been there the longest.<a href="#40"><sup>40</sup></a></p>
...
<p className='purple-bold'>Good Example #5</p>
<p className='indent-text-1'>The thin man on the witness stand fumbled with the edge of his necktie.<a href="#f41"><sup>41</sup></a></p>
...
<p className='purple-bold'>Good Example #6</p>
<p className='indent-text-1'>I've thought about it a lot, man; like why Victor and I made that terrible scene out there at San Quentin, putting ourselves on that it was just for kicks.<a href="#f42"><sup>42</sup></a></p>
...
<p className='purple-bold'>Good Example #7</p>
<p className='indent-text-1'>It's midnight now.<a href="#f43"><sup>43</sup></a></p>
...
<p className='purple-bold'>Good Example #8</p>
<p className='indent-text-1'>With dull curiosity he watched the crowds gathering far below on the sidewalk.<a href="#f44"><sup>44</sup></a></p>
...
<p className='purple-bold'>Good Example #9</p>
<p className='indent-text-1'>There was no path, only the almost vertical ascent.<a href="#f45"><sup>45</sup></a></p>
...
<p className='purple-bold'>Good Example #10</p>
<p className='indent-text-1'>Don Cassidy first noticed her after he gave an open-ended assignment to the students enrolled in his English literature class at the Queens campus of St. John's University: Write a theme about something wonderful in your life that has happened to you.<a href="#f46"><sup>46</sup></a></p>
...
<p className='purple-bold'>Good Example #11</p>
<p className='indent-text-1'>Telephones and telephone bells have always made me uneasy.<a href="#f47"><sup>47</sup></a></p>
...
<div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f7">A Border-line Case, <i>Not After Midnight, and other stories.</i></li>
                    <li id="f8">The Apple Tree, <i>The Birds and Other Stories.</i></li>
                    <li id="f9">Ardor, <i>Swift to Chase.</i></li>
                    <li id="f10">(Little Miss) Queen of Darkness, <i>Swift to Chase.</i></li>
                    <li id="f11">Hallucigenia, <i>The Imago Sequence.</i></li>
                    <li id="f12">Parallax, <i>The Imago Sequence.</i></li>
                    <li id="f13">The Imago Sequence, <i>The Imago Sequence.</i></li>
                    <li id="f14">Six Six Six, <i>Occultation and Other Stories.</i></li>
                    <li id="f15">The Lagerstätte, <i>Occultation and Other Stories.</i></li>
                    <li id="f16">Mysterium Tremendum, <i>Occultation and Other Stories.</i></li>
                    <li id="f17">Strappado, <i>Occultation and Other Stories.</i></li>
                    <li id="f18">The Stepford Wives, <i>Ira Levin.</i></li>
                    <li id="f19">The Chalk Man, <i>C. J. Tudor.</i></li>
                    <li id="f20">Little Broken Things, <i>Nicole Baart.</i></li>
                    <li id="f21">The Becoming of Noah Shaw, <i>Michelle Hodkin.</i></li>
                    <li id="f22">Elevation, <i>Stephen King.</i></li>
                    <li id="f23">Something Wicked This Way Comes, <i>Ray Bradbury.</i></li>
                    <li id="f24">Spring Fever, <i>Dorothy, Salisbury Davis.</i></li>
                    <li id="f25">New Murders for Old, <i>Carter Dickson.</i></li>
                    <li id="f26">Four O’ Clock, <i>Price Day.</i></li>
                    <li id="f27">View from the Terrace, <i>Mike Marmer.</i></li>
                    <li id="f28">Artemis, <i>Andy Weir.</i></li>
                    <li id="f29">A Tangled Mercy, <i>Joy Jordan-Lake.</i></li>
                    <li id="f30">The City of Brass, <i>S. A Chakraborty.</i></li>
                    <li id="f31">The Crate at Outpost 1, <i>Matthew Gant.</i></li>
                    <li id="f32">The Duel, <i>Joan Vatsek.</i></li>
                    <li id="f33">Call for Help, <i>Robert Arthur.</i></li>
                    <li id="f34">Scott Free, <i>Miriam Lynch.</i></li>
                    <li id="f35">The Last Witness, <i>Robert Colby.</i></li>
                    <li id="f36">Something Short of Murder, <i>Henry Slesar.</i></li>
                    <li id="f37">Old Virginia, <i>Laird Barron.</i></li>
                    <li id="f38">Petey, <i>T.E.D Klein.</i></li>
                    <li id="f39">The Birds, <i>Daphne Du Maurier.</i></li>
                    <li id="f40">The New Deal, <i>Charles Einstein.</i></li>
                    <li id="f41">Boomerang, <i>Guy Fleming.</i></li>
                    <li id="f42">The Second Coming, <i>Joe Gores.</i></li>
                    <li id="f43">Prey, <i>Michael Crichton.</i></li>
                    <li id="f44">Man with a Problem, <i>Donald Honig.</i></li>
                    <li id="f45">They Bite, <i>Anthony Boucher.</i></li>
...
{/* ---------------------------------------------------------------------------------------------- */}
          ...
          <aside className="col-md-4 blog-sidebar">
            ...
            <h4 className="font">Index</h4>
              ...
              <li><a href="#post-17-1">17.1: Why the First Words Matter</a></li>
                <li><a href="#post-17-2">17.2: The 4 'W's</a></li>
                <li><a href="#post-17-3">17.3: Wide or Narrow</a></li>
                <li><a href="#post-17-4">17.4: Close or Distant</a></li>
                <li><a href="#post-17-5">17.5: A Big Scene and a Small Scene</a></li>
                <li><a href="#post-17-6">175.6: Order of Information</a></li>
                <li><a href="#post-17-7">17.7: First Line</a></li>
              </ol>
            </div>
