        ...
        <div className="row">
          <div className="col-md-8 blog-main">
            <div className="blog-post">
              ...
              <div id="content">
                ...
                <p className='indent-text-1'>No one would have believed in the last years of the nineteenth century that this world was being watched keenly and closely by intelligences greater than man's...<FootnoteRef text="War of the Worlds, H.G. Wells." /></p>

                <p><strong>Narrow:</strong></p>
                <p className='indent-text-1'>Mother died today. Or maybe yesterday; I can't be sure. <FootnoteRef text="The Stranger, Albert Camus." /></p>

                <p><strong>Wide:</strong></p>
                <p className='indent-text-1'>It was now lunch time and they were all sitting under the double green fly of the dining tent pretending that nothing had happened.<FootnoteRef text="The Short Happy Life of Francis Macomber, Ernest Hemingway." /></p>
                ...
                <p>Hart says:<FootnoteRef text="Jack Hart, Storycraft: Complete Guide to Writing Narrative Nonfiction." /> You also can create a sense of narrative motion by describing the approach to a scene, moving from the long view to the scene itself, as here:</p>
               
                <p className='indent-text-1'>In daylight, in an all but treeless, baked brown landscape, Sanmi Lasante makes a dramatic appearance, like a fortress on its mountainside, a large complex of concrete buildings, half covered with tropical greenery. Inside the walls, the world turns leafy. Tall trees stand beside courtyards and walkways and walls, artful constructions of concrete and stone, which mount the forested hillside.<FootnoteRef text="Mountains Beyond Mountains: The Quest of Dr. Paul Farmer, A Man Who Would Cure the World, Tracy Kidder." /></p>
                ...
                <p>R. Meredith and J. Fitzgerald<FootnoteRef text="Robert Meredith and John Fitzgerald, Structuring Your Novel: From Basic Idea to Finished Manuscript." /> say that the first chapter should have a ‘big scene’ for conflict, and a ‘small scene’ for characterisation and providing preliminary information (to answer the initial ‘who, what, where, why’). </p>
                ...
                <p>William Sloane<FootnoteRef text="William Sloane, The Craft Of Writing." /> says: <i>“Those first sentences of a novel are a contract between the writer of fiction and the reader who commences to read him. The contract has to be clear almost at once.”</i></p>
                ...
                <p className='indent-text-1'>Last night I dreamt of Manderley again...<FootnoteRef text="Rebecca." /></p>
                <p className='indent-text-1'>"Don't look now," John said to his wife, "but there are a couple of old girls two tables away who are trying to hypnotise me."<FootnoteRef text="Don’t Look Now, Not After Midnight and Other Stories." /></p>
                <p className='indent-text-1'>They told me afterwards they had found nothing.<FootnoteRef text="Monte Verità, The Birds and Other Stories." /></p>
                <p className='indent-text-1'>On December the third the wind changed overnight and it was winter.<FootnoteRef text="The Birds, The Birds and Other Stories." /></p>
                <p className='indent-text-1'>He had been asleep for about ten minutes.<FootnoteRef text="A Border-line Case, Not After Midnight And Other Stories." /></p>
                <p className='indent-text-1'>It was three months after she died that he first noticed the apple tree.<FootnoteRef text="The Apple Tree, The Birds and Other Stories." /></p>
                ...
                <p className='indent-text-1'>What is it Pilot John says right before we drop from the sky? Where is Molly’s body? <FootnoteRef text="Ardor, Swift to Chase." /></p>
                <p className='indent-text-1'>I write this: The cops don’t know what really happened in Eagle Talon. Lies, all lies. Ask Jessica, if I ever see her again. <FootnoteRef text="(Little Miss) Queen of Darkness, Swift to Chase." /></p>
                <p className='indent-text-1'>The Bentley nosed into the weeds along the shoulder of the road and died.<FootnoteRef text="Hallucigenia, The Imago Sequence." /></p>
                <p className='indent-text-1'>I see Miranda in the endless chain of faces.<FootnoteRef text="Parallax, The Imago Sequence." /></p>
                <p className='indent-text-1'>Like the Shroud of Turin, the disfigured shape in the photograph was a face waiting to be born.<FootnoteRef text="The Imago Sequence, The Imago Sequence." /></p>
                <p className='indent-text-1'>...Over the course of the long afternoon of thunderclaps and rain squalls they had unpacked most of the living room of the ancestral home.<FootnoteRef text="Six Six Six, Occultation and Other Stories." /></p>
                <p className='indent-text-1'>October 2004 Virgil acquired the cute little blue-and-white-pinstriped Cessna at an auction; this over Danni’s strenuous objections.<FootnoteRef text="The Lagerstätte, Occultation and Other Stories." /></p>
                ...
                <p className='indent-text-1'>Kenshi Suzuki and Swayne Harris had a chance reunion at a bathhouse in an Indian tourist town.<FootnoteRef text="Strappado, Occultation and Other Stories." /></p>
                ...
                <p className='indent-text-1'>The girl’s head rested on a small pile of orange-and-brown leaves.<FootnoteRef text="The Chalk Man, C. J. Tudor." /></p>
                ...
                <p className='indent-text-1'>A pile of dead leaves rested on the girl’s head.</p>
                ...
                <p className='indent-text-1'>The little girl's hair is fine as cornsilk.<FootnoteRef text="Little Broken Things, Nicole Baart." /></p>
                ...
                <p className='indent-text-1'>We are a tearless, tiny crowd, we survivors of David Shaw.<FootnoteRef text="The Becoming of Noah Shaw, Michelle Hodkin." /></p>
                ...
                <p className='indent-text-1'>Scott Carey knocked on the door of the Ellis condo unit, and Bob Ellis (everyone in Highland Acres still called him Doctor Bob, although he was five years retired) let him in.<FootnoteRef text="Elevation, Stephen King." /></p>
                ...
                <p className='indent-text-1'>First of all, it was October, a rare month for boys.<FootnoteRef text="Something Wicked This Way Comes, Ray Bradbury." /></p>
                ...
                <p className='indent-text-1'>Sarah Shepherd watched her husband come down the stairs.<FootnoteRef text="Spring Fever, Sarah Shepherd." /></p>
                ...
                <p className='indent-text-1'>Hargreaves did not speak until he had turned on two lamps.<FootnoteRef text="New Murders for Old, Carter Dickson." /></p>
                ...
                <p className='indent-text-1'>The hands of the alarm clock on the table in front of Mr. Crangle stood at 3:47, on a summer afternoon.<FootnoteRef text="Four O' Clock, Price Day." /></p>
                ...
                <p className='indent-text-1'>The red-orange sun eased its way out of the Jamaican sky, then suspended itself halfway into the Caribbean horizon as though holding still for some divine time exposure.<FootnoteRef text="View From The Terrace, Mike Marmer." /></p>
                ...
                <p className='indent-text-1'>I bounded over the gray, dusty terrain toward the huge dome of Conrad Bubble.<FootnoteRef text="Artemis, Andy Weir." /></p>
                ...
                <p className='indent-text-1'>Later, Tom Russell would wonder if the very boards of that place—splintered, unpainted, unlovely—had leaked some sort of lethal courage into his blood and made him see things that could not be true.<FootnoteRef text="A Tangled Mercy, Joy Jordan-Lake." /></p>
                ...
                <p className='indent-text-1'>He was an easy mark.<FootnoteRef text="The City of Brass, S. A. Chakraborty." /></p>
                ...
                <p className='indent-text-1'>The wind whistled through the valley, and the pyramidal tent that signified Outpost 1 quivered before the blast.<FootnoteRef text="The Crate at Outpost 1, Matthew Grant." /></p>
                ...
                <p className='indent-text-1'>When Janine stopped talking, sometimes as now she seemed to stop breathing also, as if to listen.<FootnoteRef text="The Duel, Joan Vatsek." /></p>
                ...
                <p className='indent-text-1'>For the tenth time that day, in a voice that shook a little, Martha Halsey read aloud the item in the Dellville Weekly Call.<FootnoteRef text="Call for Help, Robert Arthur." /></p>
                ...
                <p className='indent-text-1'>Henry Tolman got away with murder—he loved that phrase and often turned it over in his mind, gloating.<FootnoteRef text="Scott Free, Miriam Lynch." /></p>
                ...
                <p className='indent-text-1'>I was waiting on the courthouse steps when Norma Krueger, my stepmother, and Russ Tyson, her lover, came out of the building into the harsh November sunlight of Los Angeles.<FootnoteRef text="The Last Witness, Robert Colby." /></p>
                ...
                <p className='indent-text-1'>Fran came out of Lila's apartment, shoving the green-printed racing sheets into her apron pocket.<FootnoteRef text="Something Short of Murder, Henry Slesar." /></p>
                ...
                <p className='indent-text-1'>On the third morning I noticed that somebody had disabled the truck.<FootnoteRef text="Old Virginia, Laird Barron." /></p>
                ...
                <p className='indent-text-1'>'Let's face it, Doctor, if an inmate's suicidal there ain't a hell of a lot you can do.’<FootnoteRef text="Petey, T.E.D. Klein." /></p>
                ...
                <p className='indent-text-1'>On December the third the wind changed overnight and it was winter.<FootnoteRef text="The Birds, Daphne Du Maurier." /></p>
                ...
                <p className='indent-text-1'>Rafferty was not the only one losing at the blackjack table, but he had been there the longest.<FootnoteRef text="The New Deal, Charles Einstein." /></p>
                ...
                <p className='indent-text-1'>The thin man on the witness stand fumbled with the edge of his necktie.<FootnoteRef text="Boomerang, Guy Fleming." /></p>
                ...
                <p className='indent-text-1'>I've thought about it a lot, man; like why Victor and I made that terrible scene out there at San Quentin, putting ourselves on that it was just for kicks.<FootnoteRef text="The Second Coming, Joe Gores." /></p>
                ...
                <p className='indent-text-1'>It's midnight now.<FootnoteRef text="Prey, Michael Crichton." /></p>
                ...
                <p className='indent-text-1'>With dull curiosity he watched the crowds gathering far below on the sidewalk.<FootnoteRef text="Man With A Problem, Donald Honig." /></p>
                ...
                <p className='indent-text-1'>There was no path, only the almost vertical ascent.<FootnoteRef text="They Bite, Anthony Boucher." /></p>
                ...
                <p className='indent-text-1'>Don Cassidy first noticed her after he gave an open-ended assignment to the students enrolled in his English literature class at the Queens campus of St. John's University: Write a theme about something wonderful in your life that has happened to you.<FootnoteRef text="Facing The Wind, Julie Salamon." /></p>
                ...
                <p className='indent-text-1'>Telephones and telephone bells have always made me uneasy.<FootnoteRef text="The Fly, George Langelaan." /></p>
          ...
          <aside className="col-md-4 blog-sidebar">
            <div className="p-3 mb-3 blue rounded">
              ...
              <p className="mb-0-1">The start of a piece of writing should establish basic story facts, setting up the story's core elements.</p>
            </div>
