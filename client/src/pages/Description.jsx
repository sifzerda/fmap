    ...
    <div>
      ...
      <div className="jumbotron p-3 p-md-3 text-white text-center rounded bg-dark">
        ...
        <div id="wrapper" className="text-left">
          <p className="lead my-3">“When I use a word,” Humpty Dumpty said, in rather a scornful tone, “it means just what I choose it to mean—neither more nor less.”<br></br>
            “The question is,” said Alice, “whether you can make words mean so many different things.”
          </p>
          <i>— Alice in Wonderland, Lewis Carroll </i>
          <p className="lead my-3">Prose is architecture, not interior decoration </p>
        ...
        <div className="row">
          <div className="col-md-8 blog-main">
            <div className="blog-post">
              ...
              <div id="content">
                ...
                <p>Jack Hart provides this example:<FootnoteRef text="Jack Hart, Storycraft: Complete Guide to Writing Narrative Nonfiction." /></p>
                ...
                <h5>11.1.2 	The ‘California Scene’</h5>
                ...
                <h5>11.1.3 	Support Statements with Facts</h5>
                ...
                <h5>11.1.4 	Don’t Describe Sunsets</h5>
                ...
                <h2 id="post-11-2" className="blog-post-title">11.2: A Common Pitfall</h2>
                ...
                <h2 id="post-11-3" className="blog-post-title">11.3: Information Economy</h2>
                ...
                <h5>Some of these points are elaborated below:</h5>
                ...
                <p className='indent-text-1'><i>The Television Centre...is a vision of the future with huge, glassed-in newsrooms, and reception areas that look like they've been hit with [a] pastel bomb...</i><FootnoteRef text="Danny Wallace, Yes Man, (non-fiction)." /></p>
                ...
                <p>Another example:</p>
                <p className='indent-text-1'><i>"The door opened finally on a forbiddingly dark and chilly vestibule."</i><FootnoteRef text="Claudia Osborne, Over My Head, (non-fiction)." /></p>
                ...
                <p className='indent-text-1'><i>The tommy gun fit weirdly into a violin case, making a gangster look like he was going to a music recital.</i><FootnoteRef text="William Elliott Hazelgrove, Shots Fired in Terminal 2: A Witness to the Fort Lauderdale Shooting Reflects on America's Mass Shooting Epidemic, (non-fiction)" /></p>
                ...
                <p className='indent-text-1'>The main street of Starbuck is deserted, save four men in hunting camo outside Archie&apos;s Meats and Groceries, loading paper bundles of bloody meat into the back of a pickup truck. Only the store and hotel restaurant appear to be open.<FootnoteRef text="Tom Jolkinen, Curtains, (note: this is non-fiction)." /></p>
                ...
                <h5>11.3.3 	Outside Before Inside</h5>
                ...
                <p>Jack Hart <FootnoteRef text="Jack Hart, Storycraft: Complete Guide to Writing Narrative Nonfiction." /> explains that storytelling at different distances requires two different kinds of narrative, each of them essentially a different language. When the distance is great, when you step way back from the action, you write in summary narrative, collapsing time and space into a dispassionate account, viewed from above. When you shrink the distance, you shift into scenic narrative, going inside the scene as it unfolds, as if it was happening to you. </p>
                ...
                <div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f3">Jack Bickham, <i>The 38 Most Common Fiction Writing Mistakes (And How To Avoid Them)</i></li>
                    <li id="f4">Danny Wallace, <i>Yes Man</i>, (note: this is non-fiction).</li>
                    ...
                    <li id="f12">Alexandra Adornetto, <i>Ghost House.</i></li>
                    <li id="f13">Sol Stein, <i>How To Grow A Novel.</i></li>
                    <li id="f14">Sol Stein, <i>How To Grow A Novel.</i></li>
                    <li id="f15">Daphne Du Maurier <i>Don't Look Now.</i></li>
          ...
          <aside className="col-md-4 blog-sidebar">
            <div className="p-3 mb-3 blue rounded">
              ...
              <p className="mb-0-1">Description should advance the plot or promote conflict or provide character development.</p>
            </div>

            <div className="p-3 mb-3 blue rounded">
              <h4 className="font">Index</h4>
              <ol className="list-unstyled mb-0">
                <li><a href="#post-11-1">11.1: Show Don't Tell</a></li>
                <li><a href="#post-11-2">11.2: A Common Pitfall</a></li>
                <li><a href="#post-11-3">11.3: Information Economy</a></li>
                <li><a href="#post-11-4">11.4: Most Unusual to Least Unusual</a></li>
                <li><a href="#post-11-5">11.5: Metaphors and Similies</a></li>
                <li><a href="#post-11-6">11.6: The Hierarchy of Best Description</a></li>
                <li><a href="#post-11-7">11.7: Break Up Adjectives</a></li>
                <li><a href="#post-11-8">11.8: How Frequent Should Description Be?</a></li>
                <li><a href="#post-11-9">11.9: Make the Abstract Concrete</a></li>
                <li><a href="#post-11-10">11.10: Describe Things as Other Things</a></li>
                <li><a href="#post-11-11">11.11: Emphasize by Contrast</a></li>
                <li><a href="#post-11-12">11.12: Chain Link Paragraphs</a></li>
                <li><a href="#post-11-13">11.13: Drama by Omission</a></li>
                <li><a href="#post-11-14">11.14: Wide and Narrow Description</a></li>
                <li><a href="#post-11-15">11.15: The Ladder of Abstraction</a></li>
                <li><a href="#post-11-16">11.16: Description Foils</a></li>
                <li><a href="#post-11-17">11.17: Time Markers</a></li>
                <li><a href="#post-11-18">11.18: Gravity</a></li>
                <li><a href="#post-11-19">11.19: Description in Action</a></li>
              </ol>
            </div>
