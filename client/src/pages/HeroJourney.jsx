    ...
    return (
        <div>
            ...
            <div className="jumbotron p-3 p-md-5 text-white text-center rounded bg-dark">
                <h1 className="display-4">The Hero&apos;s Journey</h1>

                <div id="wrapper" className="text-left">
                    <p className="lead my-3">You enter the forest at the darkest point, where there is no path. Where there is a way or path, it is someone else&apos;s path. You are not on your own path. If you follow someone else&apos;s way, you are not going to realize your potential. </p>
                    <i>—  Joseph Campbell</i>
                </div>
            </div>
                    ...
                    <div className="col-md-8 blog-main">
                        <div className="blog-post">
                            ...
                            <div id="content">
                                ...
                                <h2 className="blog-post-title" id="post-act-ii">Act II. Initiation</h2>
