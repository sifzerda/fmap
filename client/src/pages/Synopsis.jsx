import '../App.css'
//import synBanner from '../assets/synbanner.jpg'
  ...
  return (
    <div>
      ...
      <div className="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <h1 className="display-4">Synopsis</h1>
          ...
          <div className="col-md-8 blog-main">
            <div className="blog-post">
              ...
              <div id="content">
                ...
                <h2 id="post-25-2" className="blog-post-title">25.2 What Is A Synopsis?</h2>
                ...
                <h6>(2) Fight the temptation to ‘sex’ up (i.e. dress up) your manuscript </h6>
                ...
                <h6>(3) Write your synopsis in present tense</h6>
                ...
                <p className="code-left"><code><i>When Sally's mother dies unexpectedly, Sally is left reeling and barely able to cope. At the funeral, Sally drops to the ground and screams until her relatives take her out. </i></code></p>
                ...
                <p className="code-left"><code><i>Sally’s mother dies unexpectedly. At the funeral, Sally drops to the ground and screams until her relatives take her out. </i></code></p>

                <h5>21.4.2 The 3-Step Method</h5>
                ...
                <ol><li><strong>(1) The Set-Up</strong> This does two things:
                  <ol>
                ...
                <ol><li><strong>Event:<span className='red-text-x'> L moves to Ludlow;</span></strong>
                  <ol><li><strong>Effect: </strong>Dangers are introduced into L and his family’s lives; the remoteness of the area, and dangerous road;</li></ol>
                </li>

                  <li><strong>Event:</strong> L saves his neighbour’s wife through his medical background;
                    <ol><li><strong>Effect: </strong>The neighbour decides to pay back L by taking him to the nearby burial ground which can resurrect the dead;</li></ol>
                  </li>

                  <li><strong>Event: </strong>L's cat is killed
                    <ol><li><strong>Effect: </strong>L is compelled to bury the cat in the burial ground to prevent his daughter finding out that it died;</li></ol>
                  </li>

                  <li><strong>Event: </strong>L uses the burial ground and the cat is resurrected;
                    <ol><li><strong>Effect: </strong>The cat acts strange, disturbing L and his family;</li></ol></li>

                  <li><strong>Event: </strong>Raising his concern to the neighbour, L is warned about those previously resurrected;
                    <ol><li><strong>Effect: </strong>L is discouraged from further use of the burial ground</li></ol>
                  </li>

                  <li><strong>Event: </strong>L’s son is hit by a truck and killed;
                    <ol><li><strong>Effect: </strong>L is tempted to use the burial ground again;</li></ol>
                  </li>

                  <li><strong>Event: <span className='blue-text-x'>L buries his son in the burial ground;</span></strong>
                    <ol><li><strong>Effect: </strong>L’s son is resurrected, and is a demonic version of himself;</li></ol>
                  </li>

                  <li><strong>Event: </strong>L’s resurrected son kills the neighbour and his mother, L’s wife;
                    <ol><li><strong>Effect: </strong>L’s wife’s death gives L renewed motivation to use the burial ground</li></ol>
                  </li>
...
<div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f2">This is where you have a separate series which is the sequel of another separate series, e.g. David Eddings’ <i>the Mallorean</i> series is the sequel of his <i>the Belgariad </i> series. </li>
                    <li id="f2">This is where you have a canon of works (including series, prequels and spin-offs) set in the same story world, such as (in addition to <i>the Mallorean</i> and <i>the Belgariad</i>, <i>Belgarath the Sorcerer</i>, and <i>Polgara the Sorceress).</i> </li>
                    <li id="f4">This is where you have works set in the same story world, but including those not by the original author, e.g. the Lovecraft Mythos, created by or originating with H. P. Lovecraft but contributed to by authors such as Frank Belknap Long, August Derleth,  Robert Bloch, Robert E. Howard, and Clark Ashton Smith.</li>
                    <li id="f5">Bob Mayer, <i>Fiction Writers’ Toolkit.</i></li>
                  </ol>
                </div>
          ...
          <aside className="col-md-4 blog-sidebar">
            ...
            <div className="p-3 mb-3 blue rounded">
              ...
              <ol className="list-unstyled mb-0">
                <li><a href="#post-25-1">25.1 Purpose of a Synopsis</a></li>
                <li><a href="#post-25-2">25.2 What Is A Synopsis?</a></li>
                <li><a href="#post-26-3">25.3 The Value of A Synopsis</a></li>
                <li><a href="#post-26-4">25.4 How To Write A Synopsis</a></li>
              </ol>
            </div>
