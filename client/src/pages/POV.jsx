  ...
  return (
    <div>
      ...
      <div className="jumbotron p-3 p-md-3 text-white text-center rounded bg-dark">
        <h1 className="display-4">Point Of View</h1>

        <div id="wrapper" className="text-left">
        <p className="lead my-3">If you want to know what water is, don’t ask the fish.</p>
        <i>— Mitch Stokes </i>
        </div>
      </div>
...
<h5>14.1.1 	First Person Supporting Character </h5>

<p>A secondary character describes the protagonist, e.g.</p>

<p className="code-left"><code><i>I noticed Kevin look longingly at Mary, as if hoping she would notice him. She not only noticed him, she said: “I wish you would take me in your arms.” Then I noticed Mary’s mother watching from the window, and wondered if she thought they were a perfect match.  </i></code></p>
...
<h2 id="post-14-3" className="blog-post-title">14.3: Second Person</h2>
<p>The narrator is not a character and speaks to the reader as if the reader was the main character, e.g.</p>
<p className="code-left"><code><i>You looked longingly at Mary, hoping she would notice you. She not only noticed you, she said: “I wish you would take me in your arms.” You noticed Mary’s mother, watching from the window, and hoped she thought you were a perfect match.  </i></code></p>
...
<h2 id="post-14-4" className="blog-post-title">14.4: Third Person</h2>
...
<h5>14.3.1 	Third Person Limited </h5>
...
<p className="code-left"><code><i>Kevin looked longingly at Mary, hoping she would notice him. She not only noticed him, she said: “I wish you would take me in your arms.” Kevin noticed Mary’s mother watching from the window, and hoped she thought they were a perfect match.  </i></code></p>
<p>This perspective can be used to show a protagonist how they really are, not how they see themselves.</p>

<h5>14.3.2 	Third Person Omniscient </h5>
<p>This perspective can be used to show a protagonist how they really are, not how they see themselves.</p>
<p className="code-left"><code><i>Kevin looked longingly at Mary, hoping she would notice him. She not only noticed him, she wished he would take her in his arms. Mary’s mother, watched from the window, and thought they were a perfect match.  </i></code></p>
...
<h5>12.3.3 	Third Person Supporting Character </h5>
<p>Theoretically, you could also have a supporting character written in third person, e.g. </p>
<p className="code-left"><code><i>Sarah saw Kevin look longingly at Mary, as if hoping she would notice him. Mary not only noticed him, she said: “I wish you would take me in your arms.” Then Sarah noticed Mary’s mother watching from the window, and wondered if Mary’s mother thought Kevin and Mary were a perfect match.   </i></code><a href="#f2"><sup>2</sup></a></p>
<p>However, it’s doubtful there are many – if any – practical advantages of this POV, compared to Third Person or First Person Supporting Character. Notice how, with so many characters, you have to individually identify each person by proper name rather than pronoun and it gets cumbersome.</p>
<p>For that reason, I discourage employing it, unless you practically have no other choice.</p>

<h2 id="post-14-5" className="blog-post-title">14.5: Multiple Shifting Narrators</h2>
...
<h5>14.4.1 	Separate POVs by Chapter </h5>
...
<h2 id="post-14-6" className="blog-post-title">14.6: Which POV to Use</h2>
...
<p>He concludes: <i>"Bias aside, you ordinarily pick a stance to give readers the best angle on the unfolding story." </i></p>
<p><i>"Each story can be told from many points of view,"</i> said Don Murray, the dean of American newspaper writing coaches. <i>“It is the writer’s task to choose the point of view that will help the reader see the subject.”</i></p>

<h2 id="post-14-7" className="blog-post-title">14.7: Implied Change of POV</h2>
...
<p className='indent-text-1'><i>I smiled <u>conceitedly</u> at the glowing reviews for my latest performance.</i></p>
<p className='indent-text-1'><i>He didn’t like feeling left out. “I’ve gone sky diving, too,”  <u>he boasted.</u></i></p>
<p className='indent-text-1'><i>“That’s not fair!”  <u>I sniveled. </u></i></p>
...
<div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f3">Bob Mayer, <i>70 Solutions to Common Writing Mistakes.</i></li>
...
{/* ---------------------------------------------------------------------------------------------- */}
          ...
          <aside className="col-md-4 blog-sidebar">
            ...
            <h4 className="font">Index</h4>
              ...
              <li><a href="#post-14-1">14.1: What is Point of View?</a></li>
              <li><a href="#post-14-2">14.2: First Person</a></li>
                <li><a href="#post-14-3">14.3: Second Person</a></li>
                <li><a href="#post-14-4">14.4: Third Person</a></li>
                <li><a href="#post-14-5">14.5: Multiple Shifting Narrators</a></li>
                <li><a href="#post-14-6">14.6: Which POV to Use</a></li>
                <li><a href="#post-14-7">14.7: Implied Change of POV</a></li>
              </ol>
            </div>
