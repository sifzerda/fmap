...
<p>The most important skill you need to write fiction is storytelling. Robert McKee defines storytelling as: <i>“the creative conversion of life itself to a more powerful, clearer, more meaningful experience.”</i></p>
...
<p>Burnett helpfully says that all stories have an explosion, “...in which all parts of the whole are expelled...” piece by piece, “...from an existing pattern—the lives of the characters are jolted from their rhythm, and chaos is produced in their universe.”<a href="#f1"><sup>1</sup></a> In some stories the explosion is fast and shattering, in others, muted and delayed. It may occur at the beginning, middle or end, or the fuse may be lit early and the explosion happen later, but by the end there must be some kind of resolution or meaning created, a sense of something new created from the previous, subverted status quo.</p>

<h5>1.2.5 	Difference Between ‘Story’ and ‘Idea’</h5>

<p>Bob Mayer makes a good point that “[an] idea is not [a] story.”<a href="#f2"><sup>2</sup></a>  How you tell the idea is the story. Different writers can come up with the same idea, but tell different stories. Some good ideas cannot be made into good stories. Conversely, some bad ideas can be made into good stories (you may have heard a critic/reviewer say something like, ‘in the hands of another writer, this idea would not have worked…’)</p>
...
<p>Conversely, “[a] plot is what you do with that story,”<a href="#f3"><sup>3</sup></a>  – how you selectively arrange the events chronologically or artistically to create particular meaning, emotions or emphasis. Ten stories may all be ghost stories with the same events (haunted house, dead former tenants, cemetery, ghost, etc), but they will have different plots. One may happen within a single day, or a single hour (like in Stephen King’s 1408), and by direct first-person events, another may be spaced over hundreds of years and be uncovered through after-the-fact research done by the protagonist.</p>
...
<p>For a detailed summary of the Hero's Journey, see <Link to="/HeroJourney#post-act-i">this page</Link></p>
...
<h5>1.6.2 Slavishly adhere to good spelling and grammer</h5>
