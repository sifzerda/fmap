...
<p>Professional writer, Sol Stein<a href="#f1"><sup>1</sup></a>  breaks characterization into a number of concepts:</p>
...
<p>You can further categorise general traits into: </p><a href="#f2"><sup>2</sup></a>
...
<p>We associate certain physical characteristics with certain personality traits. A lean man with a crooked stance may seem untrustworthy. An attractive, charming woman may have many male lovers. A physically big man may be dominant and confident. These traits can too create a stereotype. Using physical contrasts can be more interesting and create conflict by creating misimpressions. For instance, in ‘Of Mice and Men,’ Lenny is a physically big man, but he is easily frightened, and defers to George about everything. The fact that he doesn’t appear to need a carer or minder is a source of conflict in the story.</p>
...
<p>Stein<a href="#f3"><sup>3</sup></a> provides the tip to contrast traits against each other, in order to emphasise one of those traits. To me, this sounds similar to creating foils (see below) except instead of the foils being separate characters, they are separate traits or details existing in one character.</p>
...
<p>For instance, in Lord of the Flies, the boys’ victimising the weaker ‘Piggy’ is more suspenseful than if they’d targeted the more cunning Ralph – who has a greater capacity to run, hide, or stand up for himself – because it raises a greater threat.</p>

<h5>7.4.1.1	Direct and Indirect Characterisation</h5>
<p>Hart distinguishes between direct and indirect characterization:</p><a href="#f4"><sup>4</sup></a>
...
<p>Although choice consequences must be ‘tangible,’ not all choices should be ‘life or death.’ Some choices may be relatively superficial. One example is the choice of School House (or preference influence) in Harry Potter and the Philosopher’s Stone. This choice is more symbolic for the protagonist; telling us something about him rather than opening or closing doors down the track.</p>
...
<p>As a basic rule, Frey<a href="#f6"><sup>6</sup></a> says characters must always be acting at ‘maximum capacity.’ This means your protagonist’s action must always be moving toward their plot relevant goals. Your character doesn’t get a ‘day off’ from the plot. If you want to slow down your protagonist’s progression, you need to create obstacles. These can be external or internal. By ‘internal’ I don’t mean ‘change of mind’ or ‘indecision’, I mean personal demons or flaws.</p>
...
<p>(6)	You will attempt to justify time spent creating all those BS details by cramming them here, there, and everywhere in your book, e.g.
“Bastian, you must give the childlike empress her true name.”
“I dub thee, ‘Butterscotch Ripple’ – it’s my favourite flavour of icecream.” </p>
...
<p>Mittelmark and Newman  say that, if the plot does not concern the workplace, the character doesn't have to go to work. If it doesn't centre on a love affair, the character is celibate. The character's age, class and ethnicity are a matter of guesswork.</p>
...
<p>Robert McKee distinguishes ‘Characterisation’ and ‘Character.’ The former is the sum of your character, while the latter is the heart/truth of your character.</p>
...
<p>In his study on suicide, Edwin Shneidman says:  <i>"For practical purposes, most suicides tend to fall into one of five clusters of psychological needs. They reflect different kinds of psychological pain.”</i></p>
<p>These are:</p>
<ul>
...
<p>In real life, McKee states people are conservative (I use my own term ‘economic’) – that is, they go for the easiest option unless incentivized to do something more difficult.   </p>
...
<p>McKee makes a helpful point: For every event in your story, each character will have a different reaction. And – </p>
...
<p>Burnett states that, <i>“...dull characters become more interesting against exotic backgrounds …[and] complicated and alien individuals stand out best against simplicity.”</i></p>
...
<ul>
  <li>Detective Fingerling and Topsy Kretts (The Number 23);</li>
  <li>Cypher Raige (After Earth);</li>
  <li>Harry Hole (The Snowman);</li>
  <li>Shadow Moon (American Gods);</li>
  <li>Moredeth (“More death” – he’s a villain) (Wheel of Time);</li>
  <li>Tookie De La Crème (Moddelland);</li>
  <li>Wicks Cherrycoke (Mason & Dixon);</li>
  <li>Del Capslock (Lucas Davenport);</li>
  <li>Bucky Wunderlick (Bucky Wunderlick)</li>
  <li>Darken Rahl (Sword of Truth);</li>
  <li>Zaspahr Clyntahn (pronounced Zasper Clinton) (Seafold);</li>
...
<p><u>Want:</u> According to John Yorke, a character who is passive is "effectively dead." A character is passive if they don't want anything. If they don't want anything, they have no reason to act.</p>
