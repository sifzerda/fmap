  ...
  return (
    <div>
      ...
      <div className="jumbotron p-3 p-md-3 text-white text-center rounded bg-dark">
        <h1 className="display-4">Main Characters</h1>
        ...
        <div className="row">
          <div className="col-md-8 blog-main">
            <div className="blog-post">
              ...
              <div id="content">
                ...
                <h5>7.1.1 	Rosencrantz and Guildenstern are Undead</h5>
                ...
                <div className="p-3 mb-3 rounded custom-light-box">
                  ...
                  <p></p><i>— Jack Bickham</i><FootnoteRef text="Jack Bickham, The 38 Most Common Fiction Writing Mistakes (And How To Avoid Them)." />
                </div>
                ...
                <h5>7.4.1 	Parts of a Character:</h5>
                <p>Professional writer, Sol Stein<FootnoteRef text="Sol Stein, On Writing." /> breaks characterization into a number of concepts:</p>
                ...
                <p><strong>(2)	Disposition</strong></p>
                ...
                <p><strong>(4)	Individuality</strong></p>
                ...
                <p><strong>(5)	Eccentricity</strong></p>
                ...
                <h5>7.4.2 	Four Sides of a Character</h5>
                ...
                <p className='purple-bold'>I.	General Traits</p>
                <p>These are traits formed by heredity and environment. </p>
                <p>You can further categorise general traits into:<FootnoteRef text="Storycraft: Complete Guide to Writing Narrative Nonfiction, Jack Hart." /> </p>

                <p><strong>(a)	Universal Traits:</strong></p>
                ...
                <p><strong>(b)	Nationalistic traits</strong></p>
                ...
                <p><strong>(c)	Group traits</strong></p>
                ...
                <p className='purple-bold'>II.	Physical Traits</p>
                ...
                <p className='purple-bold'>III.	Personal Traits</p>
                ...
                <p className='purple-bold'>IV.	Emotional Traits </p>
                ...
                <h5>7.4.3 	Set Off traits (AKA Interior Foils)</h5>
                <p>Stein<FootnoteRef text="Sol Stein, On Writing." /> provides the tip to contrast traits against each other, in order to emphasise one of those traits. To me, this sounds similar to creating foils (see below) except instead of the foils being separate characters, they are separate traits or details existing in one character.</p>
                ...
                <p>Stein says: <i>“...when introducing a character who will be in a position of power in a scene, suggest that character’s vulnerability before the character exercises power. Conversely, when introducing a character who will be hurt emotionally or physically in the scene to come, show the character’s strength at the outset.”</i></p>
                ...
                <p>For instance, in Lord of the Flies,<FootnoteRef text="Lord of the Flies, William Golding." /> the boys’ victimising the weaker ‘Piggy’ is more suspenseful than if they’d targeted the more cunning Ralph – who has a greater capacity to run, hide, or stand up for himself – because it raises a greater threat.</p>

                <h5>7.4.1.1	Direct and Indirect Characterisation</h5>
                <p>Hart distinguishes between direct and indirect characterization:<FootnoteRef text="Jack Hart, Storycraft: Complete Guide to Writing Narrative Nonfiction." /></p>
                <p className='purple-bold'>I.	Indirect characterisation  </p>
                <p>This is where you simply describe character traits.</p>
                <p>Hart says: <i>"the best modern fiction and nonfiction writers let a character’s visible persona speak for itself, the method [Janet] Burroway calls 'direct characterization.' They may occasionally comment on character. But mostly they choose to include details that lead readers to certain inevitable conclusions about the character they are describing."</i></p>

                <p className='purple-bold'>I.	Indirect characterisation  </p>
                <p>Direct characterization includes:</p>

                <p className='blue-bold'>I.	Indirect characterisation  </p>
                ...
                <p className='blue-bold'>(2) Movements, Expressions and Mannerisms  </p>
                ...
                <p className='blue-bold'>(3) Status Indicators </p>
                ...
                <p>Far from being self-centred, materialism is a social activity, as Hart suggests: <i>"We’re social animals, and we evolved—or not—depending on how well we could read our place in the pecking order of our isolated, constantly threatened band of hunter-gatherers." We use goods to identify others' status and group -- "Do they outrank us, or we outrank them? What can we tell about what they think and behave based on what they wear, drive, or paint on their faces?"</i> </p>
                ...
                <p className='blue-bold'>(5) Anecdotes</p>
                ...
                <h2 id="post-7-5" className="blog-post-title">7.5: How to Write Character</h2>
                ...
                <h5>7.5.2 	In Response to Action </h5>
                ...
                <p className='purple-bold'>I. Weighted Choices </p>
                ...
                <p className='purple-bold'>II. Nested Choices </p>
                ...
                <p className='purple-bold'>III. Symbolic Choices </p>
                <p>Although choice consequences must be ‘tangible,’ not all choices should be ‘life or death.’ Some choices may be relatively superficial. One example is the choice of School House (or preference influence) in Harry Potter.<FootnoteRef text="The Harry Potter series, J. K. Rowling." /> This choice is more symbolic for the protagonist; telling us something about him rather than opening or closing doors down the track.</p>

                <p className='purple-bold'>IV. Genuine Choice </p>
                ...
                <h2 id="post-7-6" className="blog-post-title">7.6: Incentivizing</h2>
                ...
                <h2 id="post-7-7" className="blog-post-title">7.7: Maximum </h2>
                <p>As a basic rule, Frey<FootnoteRef text="James Frey, How to Write a Damn Good Novel Part 1." /> says characters must always be acting at ‘maximum capacity.’ This means your protagonist’s action must always be moving toward their plot relevant goals. Your character doesn’t get a ‘day off’ from the plot. If you want to slow down your protagonist’s progression, you need to create obstacles. These can be external or internal. By ‘internal’ I don’t mean ‘change of mind’ or ‘indecision’, I mean personal demons or flaws.</p>
                ...
                <p>As Frey says, <i>“If the character agonizes, so much the better.”</i></p>

                <h2 id="post-7-8" className="blog-post-title">7.8: The Foil</h2>
                ...
                <p className='purple-bold'>(I)	Canon </p>
                ...
                <p className='purple-bold'>(II)	Fugue/Variations on a Theme </p>
                ...
                <p className='purple-bold'>(III)	Crab Canon Foil </p>
                ...
                <h2 id="post-7-9" className="blog-post-title">7.9: The RPA Method</h2>
                ...
                <div className="p-3 mb-3 rounded custom-light-box">
                  ...
                  <p></p><i>— James Frey </i><FootnoteRef text="James Frey, How to Write a Damn Good Novel Part 1." />
                </div>
                ...
                <div className="p-3 mb-3 rounded custom-light-box">
                  ...
                  <p></p><i>— Stephen King </i><FootnoteRef text="PBS News Hour (2016, Oct 6), Stephen King wants to reach out and grab you — with his writing. Retrieved from 'https://www.pbs.org/newshour/show/stephen-king-wants-reach-grab-writing'." />
                </div>
                ...
                <h2 id="post-7-11" className="blog-post-title">7.11: Character vs Characterization</h2>
                <p>Robert McKee<FootnoteRef text="Robert McKee, Story: Style, Structure, Substance, and the Principles of Screenwriting." /> distinguishes ‘Characterisation’ and ‘Character.’ The former is the sum of your character, while the latter is the heart/truth of your character.</p>
                ...
                <h5>7.11.1 	How to reveal the truth about characters</h5>
                <p>If people are not under pressure, they put up appearances. If you want to reveal a secret truthful nature to your character – their ‘Character,’ so to speak – you must put them under pressure. When people are under pressure, you find out who they really are.</p>

                <h5>7.11.2 	Character Inverts Action</h5>
                ...
                <h2 id="post-7-13" className="blog-post-title">7.13: Murray's Psychological Needs</h2>
                ...
                <p><strong>Counteraction</strong></p>
                <ul>
                ...
                <p><strong>Harm-avoidance</strong></p>
                <ul>
                ...
                <p><strong>Shame-Avoidance</strong></p>
                <ul>
                ...
                <h5>7.13.1 	Character ‘Death’</h5>
                <p>In his study on suicide, Edwin Shneidman says:<FootnoteRef text="Edwin Shneidman, The Suicidal Mind." />  <i>"For practical purposes, most suicides tend to fall into one of five clusters of psychological needs. They reflect different kinds of psychological pain.”</i></p>
                <p>These are:</p>
                <ul>
                ...
                <h2 id="post-7-16" className="blog-post-title">7.16: The Law of Conservatism</h2>
                <p>In real life, McKee<FootnoteRef text="Robert McKee, Story: Style, Structure, Substance, and the Principles of Screenwriting." /> states people are conservative (I use my own term ‘economic’) – that is, they go for the easiest option unless incentivized to do something more difficult.   </p>
                ...
                <h2 id="post-7-17" className="blog-post-title">7.17: Return to the Status Quo</h2>
                <p>Where the law of conservativism relates to characters, the law of status quo relates to events and consequences. The general idea with both is that unless something weird happens, people and events should carry on normally, i.e. you should avoid situations and characters which are weird by default. Weirdness by design alienates most people.</p>
                <p>But because stories need to be interesting, you need to write in weirdness. The point of these laws (conservativism and status quo) is to require you to depart from normalcy only when weirdness has a good reason or excuse to exist.</p>
                ...
                <h5>7.14.1 	How to Deviate from Status Quo</h5>
                ...
                <h2 id="post-7-18" className="blog-post-title">7.18: It's Happened Before, It'll Happen Again</h2>
                ...
                <h2 id="post-7-19" className="blog-post-title">7.19: Better Never Than Late</h2>
                ...
                <h2 id="post-7-21" className="blog-post-title">7.21: Multi-Dimensionality</h2>
                ...
                <h5>7.21.1 	Set off Course, not Setback</h5>
                ...
                <h2 id="post-7-23" className="blog-post-title">7.23: Number of Characters</h2>
                <p>McKee<FootnoteRef text="Robert McKee, Story: Style, Structure, Substance, and the Principles of Screenwriting." /> makes a helpful point: For every event in your story, each character will have a different reaction. And – </p>
                <p className='indent-text-1'>“If two characters in your cast share the same attitude and react in kind to whatever occurs, you must either collapse the two into one, or expel one from the story. When characters react the same, you minimize opportunities for conflict. Instead, the writer's strategy must be to maximize these opportunities.”</p>
                ...
                <h2 id="post-7-26" className="blog-post-title">7.26 Naming Your Character</h2>
                <p>Like the book’s title, character names are important. You can get names ‘wrong’, for example:</p>

                <ul>
                  <li>Detective Fingerling and Topsy Kretts;<FootnoteRef text="The Number 23, (2007)." /></li>
                  <li>Cypher Raige;<FootnoteRef text="After Earth, (2013)." /></li>
                  <li>Harry Hole;<FootnoteRef text="The Snowman, (2017)." /></li>
                  <li>Shadow Moon;<FootnoteRef text="American Gods, Neil Gaiman." /></li>
                  <li>Moredeth;<FootnoteRef text="The Wheel of Time, Robert Jordan." /></li>
                  <li>Tookie De La Crème;<FootnoteRef text="Moddelland, Tyra Banks." /></li>
                  <li>Wicks Cherrycoke;<FootnoteRef text="Mason & Dixon, Thomas Pynchion." /></li>
                  <li>Del Capslock;<FootnoteRef text="Lucas Davenport, John Sandford." /></li>
                  <li>Bucky Wunderlick</li>
                  <li>Darken Rahl;<FootnoteRef text="Sword of Truth, Terry Goodkind." /></li>
                  <li>Zaspahr Clyntahn;<FootnoteRef text="Safehold, David Weber." /></li>
                ...
                <div className="p-3 mb-3 rounded custom-light-box">
                  ...
                  <p></p><i>— Sol Stein</i><FootnoteRef text="Sol Stein, How To Grow A Novel." />
                </div>
                ...
                <h2 id="post-7-27" className="blog-post-title">7.27 Transference</h2>
                ...
                <p>Example:<FootnoteRef text="The Exorcist, William Peter Blatty." /></p>
                <p className='indent-text-1'>The air was thin and still in the darkness. Some cats at a garbage can scurried in fright as he crossed toward the house. </p>
                ...
                <h2 id="post-7-28" className="blog-post-title">7.28: Active Protagonist</h2>
                ...
                <p><u>Want:</u> According to John Yorke,<FootnoteRef text="John Yorke, How Stories Work and Why We Tell Them." /> a character who is passive is "effectively dead." A character is passive if they don't want anything. If they don't want anything, they have no reason to act.</p>
                ...
                <div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f2">Sol Stein, <i>On Writing</i></li>
                    <li id="f3">Robert Meredith and John Fitzgerald, <i>Structuring Your Novel: From Basic Idea to Finished Manuscript (Everyday Handbook).</i></li>
                    <li id="f4">Sol Stein, <i>On Writing</i></li>
                    ...
                    <li id="f7">Robie Macauley & George Lanning, <i>Technique In Fiction (2nd ed).</i></li>
                    <li id="f8">Jack Hart, <i>Storycraft: Complete Guide to Writing Narrative Nonfiction.</i></li>
                    <li id="f9">James Frey, <i>How to Write a Damn Good Novel Part 1.</i></li>
                    <li id="f10">The quote is from Thomas Williams book ‘The Hair of Harold Roux’: <i>“He has always thought of a novel, before it has taken on its first, tentative structure, as a scene on this dark plain, the characters standing around a small fire which warmly etches the edges of their faces. Distant mountains are turning moon-cold and blue as the last light fades as if forever. It is that small fire he must constantly re-create or these last warm lives will cease to live, will never have lived even to fear the immensities of coldness and indifference around them.”</i></li>
                    <li id="f11">PBS News Hour (2016, Oct 6), <i>Stephen King wants to reach out and grab you — with his writing.</i>Retrieved from <a href='https://www.pbs.org/newshour/show/stephen-king-wants-reach-grab-writing'></a></li>
                    <li id="f12">Howard Mittelmark and Sandra Newman, <i>How NOT to Write a Novel.</i></li>
                    <li id="f13">Henry A. Murray, <i>Explorations in Personality.</i></li>
                    <li id="f14">Edwin Shneidman, <i>The Suicidal Mind.</i></li>
                    <li id="f15">They can make effective side characters, however, see. e.g. ‘The Virgin Suicides.’</li>
                    <li id="f16">James Pennebaker, <i>The Secret Life of Pronouns.</i></li>
                    <li id="f17">Sol Stein, <i>How To Grow A Novel.</i></li>
                    <li id="f18">William Peter Blatty, <i>The Exorcist.</i></li>
                    <li id="f19">John Yorke, <i>How Stories Work and Why We Tell Them.</i></li>
                  </ol>
                </div>
          ...
          <aside className="col-md-4 blog-sidebar">
            <div className="p-3 mb-3 blue rounded">
              ...
              <p className="mb-0-1">The main characters are those most critically affected by the plot, with the most at stake.</p>
            </div>

            <div className="p-3 mb-3 blue rounded">
              <h4 className="font">Index</h4>
              <ol className="list-unstyled mb-0">
                <li><a href="#post-7-1">7.1: The People with the Most at Stake</a></li>
                <li><a href="#post-7-2">7.2: Ditch the Wimp</a></li>
                <li><a href="#post-7-3">7.3: Two Sources</a></li>
                <li><a href="#post-7-4">7.4: Ingredients of a Character</a></li>
                <li><a href="#post-7-5">7.5: How to Write Character</a></li>
                <li><a href="#post-7-6">7.6: Incentivizing</a></li>
                <li><a href="#post-7-7">7.7: Maximum Capacity</a></li>
                <li><a href="#post-7-8">7.8: The Foil</a></li>
                <li><a href="#post-7-9">7.9: The RPA Method</a></li>
                <li><a href="#post-7-10">7.10: The Trivia Model</a></li>
                <li><a href="#post-7-11">7.11: Character vs Characterization</a></li>
                <li><a href="#post-7-12">7.12: The 'Animal, Vegetable, or Object' Method</a></li>
                <li><a href="#post-7-13">7.13: Murray's Psychological Needs</a></li>
                <li><a href="#post-7-14">7.14: Poignant Character-Building</a></li>
                <li><a href="#post-7-15">7.15: Introducing Your Character</a></li>
                <li><a href="#post-7-16">7.16: The Law of Conservatism</a></li>
                <li><a href="#post-7-17">7.17: Return to the Status Quo</a></li>
                <li><a href="#post-7-18">7.18: It's Happened Before, It'll Happen Again</a></li>
                <li><a href="#post-7-19">7.19: Better Never Than Late</a></li>
                <li><a href="#post-7-20">7.20: Depth</a></li>
                <li><a href="#post-7-21">7.21: Multi-Dimensionality</a></li>
                <li><a href="#post-7-22">7.22: Raising the Stakes</a></li>
                <li><a href="#post-7-23">7.23: Number of Characters</a></li>
                <li><a href="#post-7-24">7.24: The 'Strange Sandwich'</a></li>
                <li><a href="#post-7-25">7.25: Earn What You Learn</a></li>
                <li><a href="#post-7-26">7.26: Naming Your Character</a></li>
                <li><a href="#post-7-27">7.27: Transference</a></li>
                <li><a href="#post-7-28">7.28: Active Protagonist</a></li>
              </ol>
            </div>
