    ...
    <div>
      ...
      <div className="jumbotron p-3 p-md-3 text-white text-center rounded bg-dark">
        ...
        <div id="wrapper" className="text-left">
          <p className="lead my-3">Dialogue is used to reveal not what we want to say, but what we are trying to hide </p>
          <i>— William Monahan</i>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-md-8 blog-main">
            <div className="blog-post">
              ...
              <div id="content">
                ...
                <h5>12.2.1 	When to not abridge</h5>
                ...
                <h2 id="post-12-4" className="blog-post-title">12.4: Action/Reaction</h2>
                ...
                <h2 id="post-12-5" className="blog-post-title">12.5: Adding Activity to Dialogue</h2>
                ...
                <h2 id="post-12-6" className="blog-post-title">12.6: Adding Conflict to Dialogue</h2>
                ...
                <h2 id="post-12-7" className="blog-post-title">12.7: Information Asymmetry</h2>
                ...
                <div className="footnotes">
                  ...
                  <ol>
                    ...
                    <li id="f3">Beverly Hopwood, <i>Katie and Ozzie.</i></li>
                    <li id="f4">Sol Stein, <i>How To Grow A Novel.</i></li>
                    <li id="f5">Mark Edward, <i>Psychic Blues. </i></li>
                  </ol>
                </div>
          ...
          <aside className="col-md-4 blog-sidebar">
            <div className="p-3 mb-3 blue rounded">
              ...
              <p className="mb-0-1">Dialogue is a construction of actual speech which is intended to advance the plot, develop character, or create conflict.</p>
            </div>

            <div className="p-3 mb-3 blue rounded">
              <h4 className="font">Index</h4>
              <ol className="list-unstyled mb-0">
                <li><a href="#post-12-1">12.1: What is Dialogue?</a></li>
                <li><a href="#post-12-2">12.2: Brevity</a></li>
                <li><a href="#post-12-3">12.3: Make Dialogue Oblique</a></li>
                <li><a href="#post-12-4">12.4: Action/Reaction</a></li>
                <li><a href="#post-12-5">12.5: Adding Activity to Dialogue</a></li>
                <li><a href="#post-12-6">12.6: Adding Conflict to Dialogue</a></li>
                <li><a href="#post-12-7">12.7: Information Asymmetry</a></li>
                <li><a href="#post-12-8">12.8: Dialogue Tags</a></li>
                <li><a href="#post-12-9">12.9: People Avoid 'Jinxing'</a></li>
                <li><a href="#post-12-10">12.10: Concrete/Abstract Statements</a></li>
                <li><a href="#post-12-11">12.11: Don't Take Sides</a></li>
                <li><a href="#post-12-12">12.12: When To Avoid Dialogue</a></li>
              </ol>
            </div>
