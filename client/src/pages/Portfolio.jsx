  ...
  return (
    <div>
      ...
      <p className='portfolio-bio'>
        Welcome to my Portfolio! This is a collection of my recent work on various projects. 
        It includes development on both front end and back end technologies using HTML, CSS, 
